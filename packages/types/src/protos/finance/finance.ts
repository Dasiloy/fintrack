...
export interface FinanceServiceClient {
  ...
  batchBudgetWorkflowActions(
    request: BatchBudgetWorkflowActionsReq,
    metadata?: Metadata,
  ): Observable<BatchBudgetWorkflowActionsRes>;
  ...
  batchRecurringWorkflowActions(
    request: BatchRecurringWorkflowActionsReq,
    metadata?: Metadata,
  ): Observable<BatchRecurringWorkflowActionsRes>;
...
export interface FinanceServiceController {
  ...
  batchBudgetWorkflowActions(
    request: BatchBudgetWorkflowActionsReq,
    metadata?: Metadata,
  ): Promise<BatchBudgetWorkflowActionsRes> | Observable<BatchBudgetWorkflowActionsRes> | BatchBudgetWorkflowActionsRes;
