...
function Input({ className, type, ...props }: React.ComponentProps<'input'>) {
  return (
    <input
      ...
      data-slot="input"
      className={cn(
        'rounded-button border-border-subtle bg-bg-surface h-11 w-full min-w-0 border',
        'px-space-4 py-space-2 text-body text-text-primary',
...
function InputLabel({ className, children, required, ...props }: InputLabelProps) {
  return (
    <label
      ...
      className={cn(
        'text-text-secondary text-[32px] font-medium',
