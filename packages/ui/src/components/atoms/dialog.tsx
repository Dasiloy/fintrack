  ...
  return (
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          "bg-bg-elevated border border-border-subtle rounded-card shadow-card",
      ...
      >
        ...
        {showCloseButton && (
          <DialogPrimitive.Close
            ...
            className={cn(
              "absolute top-space-4 right-space-4 inline-flex size-8 items-center justify-center",
              "rounded-button border border-border-subtle bg-bg-surface/80 text-text-tertiary",
...
function DialogHeader({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "flex flex-col gap-space-2 text-center sm:text-left",
        className,
      )}
      {...props}
    />
...
function DialogFooter({
  ...
  return (
    <div
      ...
      className={cn(
        "flex flex-col-reverse gap-space-2 sm:flex-row sm:justify-end",
        className,
      )}
      {...props}
    >
