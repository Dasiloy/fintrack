...
export const SUPPORT_ARTICLES: SupportArticle[] = [
  // ── Getting Started ──
  {
    ...
    body: [
      {
        type: 'lead',
        text: 'Getting started with FinTrack takes under two minutes. You can sign up with your email and password, or use Google or Apple for a one-tap setup.',
      },
        ...
        items: [
          {
            ...
            body: 'Visit fintrack.app/signup or click "Get Started" on the home page.',
          },
          {
            title: 'Enter your details',
            body: 'Type your first name, last name, email address, and a strong password (min. 8 characters).',
          },
          {
            title: 'Verify your email',
            body: 'Check your inbox for a 6-digit code and enter it on the verification screen. The code expires in 10 minutes.',
          },
          {
      ...
      {
        type: 'paragraph',
        text: 'Click "Login with Google" or "Login with Apple" on the sign-up page. Authorize the permissions, and FinTrack creates your account automatically — no email verification step required.',
      },
      {
        type: 'note',
        variant: 'tip',
        text: 'Social sign-in accounts can add a password later via Settings → Account → Set Password, so you can always log in either way.',
      },
    ],
  },
  {
    ...
    body: [
      {
        type: 'lead',
        text: "A budget in FinTrack is a monthly spending limit for a category. Creating one takes seconds — here's how.",
      },
      {
        type: 'steps',
        items: [
          {
            title: 'Open Finances → Budgets',
            body: 'From the sidebar, go to Finances and select Budgets.',
          },
          { title: 'Click "New Budget"', body: 'Hit the "+ New Budget" button in the top right.' },
          {
            title: 'Pick a category',
            body: 'Choose from your existing categories or create a new one. Examples: Groceries, Dining, Transport.',
          },
          {
            title: 'Set your limit',
            body: 'Enter the monthly spending limit in your account currency.',
          },
          {
            title: 'Save',
            body: 'Click Save. Your budget is live and will track transactions in that category for the current month.',
          },
        ],
      },
      {
        type: 'note',
        variant: 'info',
        text: 'Free accounts can create up to 5 budgets. Upgrade to Pro for unlimited budgets.',
      },
    ],
  },
  {
    ...
    body: [
      {
        type: 'lead',
        text: "FinTrack lets you add transactions manually or via receipt scan. Here's how both work.",
      },
      { type: 'h2', text: 'Manual entry' },
      {
        ...
        items: [
          {
            title: 'Go to Finances → Transactions',
            body: 'Open the Transactions tab from the sidebar.',
          },
          { title: 'Click "Add Transaction"', body: 'Fill in the amount, date, and description.' },
          {
            title: 'Assign a category',
            body: 'Pick from your existing categories. FinTrack will remember your choice for similar merchants.',
          },
        ],
      },
      ...
      {
        type: 'paragraph',
        text: "Tap the camera icon, photograph your receipt, and FinTrack's AI extracts the merchant, amount, and date automatically. Review and confirm before saving.",
      },
    ],
  },
  {
        ...
        items: [
          {
            ...
            body: 'Click your avatar in the top-right corner and select Settings, then Account.',
          },
          {
            title: 'Click "Upgrade to Pro"',
            body: "You'll see your current plan and a prominent upgrade button.",
          },
          {
            title: 'Enter payment details',
            body: 'We use Paystack for secure payment processing. Your card details are never stored on our servers.',
          },
          {
            title: 'Confirm',
            body: 'Click "Subscribe". Your account upgrades instantly — no waiting period.',
          },
        ],
      },
      {
        type: 'note',
        variant: 'tip',
        text: 'Pro renews monthly. You can cancel any time from the same Settings page and keep your Pro access until the end of the billing period.',
      },
    ],
  },
  {
    ...
    excerpt:
      'Cancel at any time — no penalties, and you keep Pro access until your billing period ends.',
    body: [
      {
        type: 'lead',
        text: 'You can cancel your Pro subscription at any time. There are no cancellation fees.',
      },
      {
        type: 'steps',
        items: [
          {
            title: 'Go to Settings → Account',
            body: 'Click your avatar, then Settings → Account.',
          },
          {
            title: 'Find your plan details',
            body: 'Your current plan and next billing date are shown here.',
          },
          {
            title: 'Click "Cancel subscription"',
            body: 'Confirm when prompted. Your plan will not renew on the next billing date.',
          },
        ],
      },
      {
        type: 'note',
        variant: 'info',
        text: 'After cancellation you keep Pro features until the end of your current billing period. After that you revert to the Free plan — your data is never deleted.',
      },
    ],
  },
  {
    ...
    body: [
      {
        type: 'lead',
        text: "Here's exactly what each plan includes so you can decide which is right for you.",
      },
  ...
  // ── Account & Security ──
  {
    ...
    body: [
      {
        type: 'lead',
        text: "You can reset your password from the login page at any time. You'll need access to your registered email address.",
      },
      {
        type: 'steps',
        items: [
          ...
          {
            title: 'Enter the OTP',
            body: 'Check your inbox (and spam folder) for the code. It expires in 15 minutes.',
          },
          {
            title: 'Set a new password',
            body: "Choose a strong password of at least 8 characters. You'll be logged in automatically.",
          },
        ],
      },
    ],
  },
  {
    ...
    body: [
      {
        type: 'lead',
        text: 'You can change your email address from the profile settings. Your current email will be notified of the change.',
      },
      {
        type: 'steps',
        items: [
          {
            ...
            body: 'Click your avatar in the top-right, then Settings → Profile.',
          },
          { title: 'Click "Change email"', body: 'Enter your new email address.' },
          {
            title: 'Verify the new address',
            body: "We'll send a verification code to your new email. Enter it to confirm the change.",
          },
        ],
      },
      {
        type: 'note',
        variant: 'warning',
        text: 'If your account was created via Google or Apple, your email is managed by that provider. Change it there first, then re-link in FinTrack.',
      },
    ],
  },
  {
    ...
    body: [
      {
        type: 'lead',
        text: 'Account deletion is permanent. All your data — transactions, budgets, goals, and settings — will be deleted and cannot be recovered.',
      },
      {
        type: 'steps',
        items: [
          ...
          },
          {
            ...
            body: 'The Delete Account option is at the bottom of the page.',
          },
          {
            title: 'Confirm deletion',
            body: 'Type your email address to confirm, then click "Delete my account".',
          },
        ],
      },
      {
        type: 'note',
        variant: 'warning',
        text: 'If you have an active Pro subscription, cancel it first to avoid being billed again. Deleting your account does not automatically cancel your subscription.',
      },
    ],
  },
  {
    ...
    body: [
      {
        type: 'lead',
        text: "FinTrack takes privacy seriously. Here's exactly what we collect and how it's used.",
      },
      {
        type: 'list',
        items: [
  ...
  // ── Budgets & Goals ──
  {
    ...
    body: [
      {
        type: 'lead',
        text: 'Goals in FinTrack let you save toward a specific target — an emergency fund, a holiday, a new laptop, or anything else.',
      },
      {
        type: 'steps',
        items: [
          ...
          {
            title: 'Set the target date (optional)',
            body: 'FinTrack will calculate how much you need to save per month to hit the deadline.',
          },
          {
            title: 'Track contributions',
            body: 'Add contributions manually or have FinTrack auto-track tagged transactions.',
          },
        ],
      },
    ],
  },
  {
    ...
    body: [
      {
        type: 'lead',
        text: 'Expense splits let you share costs with friends, family, or housemates and track who has paid.',
      },
      {
        type: 'steps',
        items: [
          ...
          },
          {
            ...
            body: "Enter the names or emails of the people in the split. They don't need a FinTrack account.",
          },
          {
            title: 'Add expenses',
            body: 'For each shared expense, enter the amount and who paid. FinTrack calculates who owes what.',
          },
          {
            title: 'Mark as settled',
            body: 'When someone pays their share, mark it as settled to keep balances accurate.',
          },
        ],
      },
      {
        type: 'note',
        variant: 'info',
        text: 'Free accounts support up to 3 active splits with 3 people each. Pro has no limits.',
      },
    ],
  },
  {
    ...
    body: [
      {
        type: 'lead',
        text: 'Recurring items represent bills or income that happen on a schedule — rent, salary, Netflix, gym memberships.',
      },
      {
        type: 'steps',
        items: [
          ...
          {
            title: 'Click "Add recurring item"',
            body: 'Enter the name, amount, and frequency (weekly, monthly, yearly).',
          },
          {
            title: 'Set the start date',
            body: 'Choose the date of the first occurrence. FinTrack will project future entries.',
          },
        ],
      },
      {
  ...
  // ── AI Features ──
  {
    ...
    body: [
      {
        type: 'lead',
        text: "AI Insights analyzes your recent transactions, budgets, and goals and generates a plain-English summary of your financial health — including what's going well and what to watch.",
      },
  ...
  },
  {
    ...
    body: [
      {
        type: 'lead',
        text: 'AI Chat lets you ask questions about your financial data in plain language — like chatting with a personal finance advisor who knows your numbers.',
      },
      {
        type: 'list',
        items: [
      ...
      },
      {
        type: 'note',
        variant: 'tip',
        text: 'AI Chat has access to your transactions, budgets, goals, and splits — but never your payment credentials or external accounts.',
      },
    ],
  },
  {
    ...
    body: [
      {
        type: 'lead',
        text: 'Receipt scanning uses AI to extract the merchant name, amount, date, and line items from a photo of your receipt.',
      },
      {
        type: 'steps',
        items: [
          {
            ...
            body: 'Go to Finances → Transactions and click "Add Transaction".',
          },
          { title: 'Tap the camera icon', body: 'This opens the receipt scanner.' },
          {
            title: 'Take or upload a photo',
            body: 'Make sure the receipt is well-lit and the text is legible.',
          },
          {
            title: 'Review the extracted details',
            body: 'AI fills in the merchant, amount, and date. Correct anything that looks off.',
          },
      ...
      },
      {
        type: 'note',
        variant: 'info',
        text: 'Free accounts get 10 receipt uploads per month. Pro gets unlimited.',
      },
    ],
  },
  ...
  // ── Troubleshooting ──
  {
    ...
    body: [
      {
        type: 'lead',
        text: "If transactions you've added aren't showing up, try these steps in order.",
      },
      {
        type: 'steps',
        items: [
          {
            ...
            body: 'Press Ctrl+Shift+R (Windows) or Cmd+Shift+R (Mac) to force a fresh load.',
          },
          {
            title: 'Check your date filter',
            body: 'Make sure the date range in the Transactions view includes the expected period.',
          },
          {
            title: 'Check the category filter',
            body: 'An active category filter may be hiding transactions. Reset filters to "All".',
          },
          {
            title: 'Wait a moment',
            body: 'Newly added transactions may take up to 30 seconds to index.',
          },
          {
            title: 'Contact support',
            body: 'If none of the above works, reach out with your account email and the transaction details.',
          },
        ],
      },
    ],
  },
  {
    ...
    excerpt:
      'Fix common login problems including wrong password, locked accounts, and OAuth errors.',
    body: [
      {
        type: 'lead',
        text: 'Having trouble logging in? Here are the most common causes and how to fix each one.',
      },
      {
        type: 'list',
        items: [
      ...
      },
      {
        type: 'note',
        variant: 'tip',
        text: 'If you signed up with Google, you must click "Login with Google" — the email/password form won\'t work for that account.',
      },
    ],
  },
  {
    ...
    body: [
      {
        type: 'lead',
        text: "Budget calculations in FinTrack are based on categorized transactions in the current calendar month. Here's why the numbers might look off.",
      },
      {
        type: 'list',
        items: [
      ...
      },
      {
        type: 'note',
        variant: 'tip',
        text: 'Click on any budget bar to see the full list of transactions contributing to it. This makes it easy to spot mismatched categories.',
      },
    ],
  },
  {
    ...
    body: [
      {
        type: 'lead',
        text: 'You can export your financial data at any time. CSV export and PDF reports are Pro features.',
      },
      { type: 'h2', text: 'CSV export' },
      {
        ...
        items: [
          ...
          {
            title: 'Click the export icon',
            body: 'Look for the download icon in the top-right of the transactions table.',
          },
      ...
      {
        type: 'paragraph',
        text: 'Go to Analytics → Reports, choose a month, and click "Generate PDF". The report includes a summary of income, spending by category, budget performance, and goal progress.',
      },
      {
        type: 'note',
        variant: 'info',
        text: 'PDF reports and CSV export are Pro-only features. Free users can request a one-time data export by contacting support.',
      },
    ],
  },
];
